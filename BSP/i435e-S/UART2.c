...
static uint8_t ReadDly=0;
static void ReadDlyDec(void)
{
	if(ReadDly)
	{
		ReadDly--;	
...
void UART2Init(uint32_t BPS)
{
	...
	BSPTimerIntervalCreate(ReadDlyDec,1);
}
